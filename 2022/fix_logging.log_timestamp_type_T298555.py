...
command = """ALTER TABLE /*_*/logging
  CHANGE log_timestamp log_timestamp BINARY(14) DEFAULT '19700101000000' NOT NULL;"""
...
def check(db):
    res = db.run_sql(f'''select data_type from information_schema.columns where
        table_schema="{db.db_name}" and
        table_name="logging" and
        column_name="log_timestamp"
    ''').splitlines()
    return res[1] == "binary"
