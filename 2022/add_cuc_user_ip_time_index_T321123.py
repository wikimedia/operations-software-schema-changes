...
command = """ALTER TABLE cu_changes ADD INDEX IF NOT EXISTS cuc_user_ip_time (cuc_user,cuc_ip,cuc_timestamp), DROP INDEX cuc_user_time;"""
...
def check(db):
    return 'cuc_user_time' not in db.run_sql('show indexes from cu_changes;')
