...
command = """use metawiki; ALTER TABLE  /*_*/oauth_accepted_consumer CHANGE  oaac_accepted oaac_accepted BINARY(14) NOT NULL;;"""
...
def check(db):
    ...
    if not query_res:
        # Dry run
        return True
    field_def = query_res.split('oaac_accepted')[1].split('\n')[0]
