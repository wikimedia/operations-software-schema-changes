...
command = """DROP  INDEX cuc_user_ip_time ON  cu_changes;ALTER TABLE  cu_changes DROP  cuc_user,DROP  cuc_user_text"""
...
def check(db):
    return 'cuc_user_ip_time' not in db.run_sql('show index from cu_changes;')
